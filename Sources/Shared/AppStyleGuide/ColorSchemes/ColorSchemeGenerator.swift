...
open class ColorSchemeGenerator{
	...
	public class func analogous(from seedColor: UIColor, range: CGFloat = 40, brightnessAdjust: CGFloat = -0.15, saturationAdjust: CGFloat = -0.15) -> [UIColor] {
	...
	public class func splitComplementary(from seedColor: UIColor, distance: CGFloat = 40, saturationAdjust: CGFloat = 0.1, brightnessAdjust: CGFloat = 0.0, shadeAdjust: CGFloat = -0.12) -> [UIColor] {
